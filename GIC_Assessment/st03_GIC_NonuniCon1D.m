% =============================================
% =     GIC Non-uniform Condcutivity 1D/3D    =
...
function [sumGIVNS,sumGIVEW] = st03_GIC_NonuniCon1D(pointerQ,GIC_GlobalSettings,GIC_Calculation,GIC_FieldData)
...
if GIC_GlobalSettings.EFieldConductivityZone==0  % Use the EPRI 1D model
    ...
    slope = abs((FromLon-ToLon)/(FromLat-ToLat));
